...
export const USER_ADD_DATABASE = 'User has been add to database and return code expired time.';
export const USER_NOT_ADD_DATABASE = 'User not added to database or body validation throw exception.';
...
export const PREVIOUS_CODE_STILL_EXIST =
    'The previous code still exists in redis, the user is already confirmed or body validation throw exception.';
export const INCORRECT_CONVERSATION_CODE = 'Incorrect conversion of code expired.';
